...
CREATE TABLE IF NOT EXISTS IMAGENS (
  ...
  CONSTRAINT fk_imagens_aviso_id FOREIGN KEY (aviso_id) REFERENCES AVISO(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS OCORRENCIA (
  ...
  PRIMARY KEY(id),
  CONSTRAINT UQ_id_seq UNIQUE(idSequencia),
  CONSTRAINT fk_ocorrencia_aviso_id FOREIGN KEY (aviso_id) REFERENCES AVISO(id)
);
